...
export class StringParam extends Param {
  ...
  constructor(name: string, value: any) {
    ...
    if (t === 'undefined' || value === null) {
      super(name, true);
      this._value = '';
    } else if (t === 'boolean' || t === 'number' || t === 'symbol' || t === 'string' || value instanceof RegExp) {
      super(name, true);
      ...
      super(name, false, ErrorMessageTemplate.failedToCast(name, 'string', JSON.stringify(value)));
    }
  }
